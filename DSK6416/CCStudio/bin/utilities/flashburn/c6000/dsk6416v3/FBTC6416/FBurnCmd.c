 ...
 * AMD29LV400B flash memory used on 6416DSK
 */
...
void EraseFlash(void)
{
	...
	*(volatile char *)FLASH_ADR1 = (char)FLASH_KEY5;
	 ...
	 */
	while((GetFlashVal(FLASH_START) & 0x80) == 0)
        ;/* Do Nothing!*/	
...
u8 GetFlashVal(unsigned long addr)
{
     ...
     */
	/* Ensure that flash is addressed as 8-bit bytes
	 * This is sort of a result of a hardware bug
	 * in 6416TEB. I just take the hardware guys'
	 * word for it...
	 */
