...
BlinkDSK6416 is an adapted DSK6416 Blink example.


To build and burn the BlinkDSK6416 example program into the Flash Memory of
the DSK6416 (assumes CCS v2.2 is installed):

1) The project file BlinkDSK6416.pjt was created to reside in directory
           C:\ti\bin\utilities\FlashBurn\c6000\dsk6416\FlashBlink6416\
...
3) Copy all of the files from the BlinkDSK6416 folder this new folder.

4) Run CCS and use the Project Menu to open the project "BlinkDSK6416.pjt"
...
5) Build the project. This should create the BlinkDSK6416.out file.
...
7) In a DOS window, change to the project directory and run the hex
   ...
   The hex conversion utility outputs a hex file, BlinkDSK6416.hex.
