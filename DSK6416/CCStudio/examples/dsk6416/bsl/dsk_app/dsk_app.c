...
void initEdma(void)
{
    ...
    gEdmaConfigXmt.dst = MCBSP_getXmtAddr(hMcbsp2);         // set the desination address to McBSP2 DXR
    ...
    gEdmaConfigRcv.src = MCBSP_getRcvAddr(hMcbsp2);         // and the desination address to McBSP2 DXR
